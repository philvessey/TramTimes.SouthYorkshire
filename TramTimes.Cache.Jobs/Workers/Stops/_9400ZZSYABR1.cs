    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            var cacheFeed = await cacheService
                .GetDatabase()
                .StringGetAsync(key: "southyorkshire:stop:9400ZZSYABR1");
            ...
            if (mappedResults.LastOrDefault()?.DepartureDateTime < DateTime.Now)
                await cacheService
                    .GetDatabase()
                    .KeyDeleteAsync(key: "southyorkshire:stop:9400ZZSYABR1");
            ...
            await cacheService
                .GetDatabase()
                .StringSetAsync(
                    key: "southyorkshire:stop:9400ZZSYABR1",
