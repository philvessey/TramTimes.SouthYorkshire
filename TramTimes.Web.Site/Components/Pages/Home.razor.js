...
export function registerBanner(_160x300, _160x600, _320x50, _468x60, _728x90, consent) {
    ...
    if (innerWidth >= 769) {
        if (innerHeight >= 600) {
            bannerTarget = document.querySelector("#home-banner-vertical ._160x600");
            bannerKey = _key160x600;
            bannerWidth = 160;
            bannerHeight = 600;
        } else {
            bannerTarget = document.querySelector("#home-banner-vertical ._160x300");
        ...
        if (innerWidth >= 728) {
            bannerTarget = document.querySelector("#home-banner-horizontal ._728x90");
            bannerKey = _key728x90;
            bannerWidth = 728;
            bannerHeight = 90;
        } else if (innerWidth >= 468) {
            bannerTarget = document.querySelector("#home-banner-horizontal ._468x60");
            bannerKey = _key468x60;
            bannerWidth = 468;
            bannerHeight = 60;
        } else {
            bannerTarget = document.querySelector("#home-banner-horizontal ._320x50");
...
export function registerResize(helper) {
    const handleResize = () => {
        ...
        _timeout = setTimeout(() => {
            ...
            ['#home-banner-horizontal', '#home-banner-vertical'].forEach(selector => {
