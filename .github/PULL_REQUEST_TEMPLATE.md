...
- [ ] Test configuration (test.ps1, test.runsettings)
- [ ] Docker configuration (cache.yml, search.yaml, server.yml)
- [ ] Server configuration (cache.sh, search.sh, server.sh)
- [ ] Documentation only
...
- **Project(s) tested**: <!-- e.g., TramTimes.Web.Site -->
...
- [ ] My commits follow the [Conventional Commits](https://conventionalcommits.org/en/v1.0.0/) specification
