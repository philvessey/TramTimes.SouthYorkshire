...
{
    [UsedImplicitly] public IResourceBuilder<PostgresServerResource>? Service { get; set; }
    [UsedImplicitly] public IResourceBuilder<PostgresDatabaseResource>? Resource { get; set; }
    [UsedImplicitly] public IResourceBuilder<IResourceWithConnectionString>? Connection { get; set; }
    [UsedImplicitly] public DatabaseParameters? Parameters { get; set; }
