    ...
    public static HostApplicationBuilder AddScheduleDefaults(this HostApplicationBuilder builder)
    {
        builder.Services.AddQuartz(configure: quartz =>
        {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    .AddJob<Development>(jobKey: init, configure: job =>
                    {
                        job.WithDescription(description: "Initial job to build the database.");
                    })
            ...
            if (!builder.Environment.IsDevelopment())
                quartz
                    .AddJob<Production>(jobKey: init, configure: job =>
                    {
                        job.WithDescription(description: "Initial job to build the database.");
                    })
                    .AddTrigger(configure: trigger =>
            ...
            if (!builder.Environment.IsDevelopment())
                quartz
                    .AddJob<Production>(jobKey: cron, configure: job =>
                    {
                        job.WithDescription(description: "Scheduled job to update the database.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYABR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYABR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYATT1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYATT2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBAM1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBAM2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBMR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBMR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBRL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYBRL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCAS1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCAS2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCAT1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCAT2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCIR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCIR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCRB1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCRB2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCRY1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCRY2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCYH1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYCYH2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDHL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDHL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDON1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDON2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDVS1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYDVS2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYFIZ1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYFIZ2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYGLE1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYGLE2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYGRC1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYGRC2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHAK1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHAK2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHDP1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHFW1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHIL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHIL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHLP1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHLP2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHLR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHLR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHOL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHOL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHYP1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYHYP2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYINF1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYINF2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYLEP1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYLEP2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYLPH1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYLPH2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMAL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMHI1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMHI2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMHS1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMHS2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMID1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMRT1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMRT2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMWY1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYMWY2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYNET1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYNET2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYNUN1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYNUN2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYPAR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYPGC1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYPGC2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYPGR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYPGR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYRTH1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYRTH2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSHL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSHL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSHU1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSHU2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSPL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYSPL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYUNI1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYUNI2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYVEN1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYVEN2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWBN1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWBN2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTF1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTF2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTL1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTL2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTR1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTR2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTS1.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
            ...
            if (builder.Environment.IsDevelopment())
                quartz
                    ...
                    {
                        job.WithDescription(description: "Verifies schedules for stop 9400ZZSYWTS2.");
                    })
                    .AddTrigger(configure: trigger =>
                    {
