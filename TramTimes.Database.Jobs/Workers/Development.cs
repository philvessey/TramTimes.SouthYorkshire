    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            await containerClient
                ...
                .UploadAsync(
                    path: localPath,
                    options: new BlobUploadOptions { HttpHeaders = new BlobHttpHeaders { ContentType = "text/csv" } });
            ...
            await containerClient
                ...
                .UploadAsync(
                    path: Path.Combine(
                        path1: storage.FullName,
                        path2: "traveline.zip"),
                    options: new BlobUploadOptions { HttpHeaders = new BlobHttpHeaders { ContentType = "application/zip" } });
            ...
            await containerClient
                ...
                .UploadAsync(
                    path: localPath,
                    options: new BlobUploadOptions { HttpHeaders = new BlobHttpHeaders { ContentType = "text/plain" } });
