    ...
    public async Task ExtraSmall()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            try
            {
                ...
                await page.Locator(selector: "span:nth-child(3) > .k-map-marker").HoverAsync();
                
                await Assertions.Expect(locator: page.Locator(selector: "#home-telerik-map__tooltip")).ToBeVisibleAsync();
                await Assertions.Expect(locator: page.Locator(selector: "#home-telerik-map__tooltip__title")).ToBeVisibleAsync();
                await Assertions.Expect(locator: page.Locator(selector: "#home-telerik-map__tooltip__services")).ToBeVisibleAsync();
            }
            catch (Exception e)
            {
                Error = e.Message;
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    ...
                    path2: "home-light-telerik-map-tooltip-extra-small.png"),
                bytes: Screenshot);
    ...
    public async Task Small()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-tooltip-small.png"),
                bytes: Screenshot);
    ...
    public async Task Medium()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-tooltip-medium.png"),
                bytes: Screenshot);
    ...
    public async Task Large()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-tooltip-large.png"),
                bytes: Screenshot);
    ...
    public async Task ExtraLarge()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-tooltip-extra-large.png"),
                bytes: Screenshot);
    ...
    public async Task ExtraExtraLarge()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-tooltip-extra-extra-large.png"),
                bytes: Screenshot);
