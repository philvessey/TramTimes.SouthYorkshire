        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    ...
                    path2: "home-light-telerik-map-extra-small.png"),
                bytes: Screenshot);
    ...
    public async Task Small()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-small.png"),
                bytes: Screenshot);
    ...
    public async Task Medium()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-medium.png"),
                bytes: Screenshot);
    ...
    public async Task Large()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-large.png"),
                bytes: Screenshot);
    ...
    public async Task ExtraLarge()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-extra-large.png"),
                bytes: Screenshot);
    ...
    public async Task ExtraExtraLarge()
    {
        ...
        await RunTestLightModeAsync(test: async page =>
        {
            ...
            await File.WriteAllBytesAsync(
                path: Path.Combine(
                    path1: AspireManager.Storage!.FullName,
                    path2: "home-light-telerik-map-extra-extra-large.png"),
                bytes: Screenshot);
